...
//  #_form_1_ ._submit { -webkit-appearance:none; cursor:pointer; font-family:arial, sans-serif; font-size:14px; text-align:center; background:#20cc1a !important; border:0 !important; -moz-border-radius:4px !important; -webkit-border-radius:4px !important; border-radius:4px !important; color:#fff !important; padding:10px !important; }
...
//     <form method="POST" action="https://ready4977.activehosted.com/proc.php" id="_form_1_" class="_form _form_1 _inline-form  _dark" novalidate>
...
//       <input type="hidden" name="or" value="08bb33ccf7c14127f6915b9d42582b68" />
//       <div class="_form-content">
//         <div class="_form_element _x87048812 _full_width " >
...
//           </div>
//         </div>
//         <div class="_form_element _x48898503 _full_width " >
...
//           </div>
//         </div>
//         <div class="_form_element _x38842313 _full_width " >
        ...
        <div className={styles.offer__inner} style={{transform:"none!important"}}>
          ...
          {isToggleLang === "ro" ? (
            <h2 className={styles.offer__title}>
              ...
              <br/>ca să îți expediem biletul online
            </h2>
          ) : (
            <h2 className={styles.offer__title}>
              Оставь данные и мы вышлем 
              <br/>тебе онлайн-билет
            </h2>
          )}
