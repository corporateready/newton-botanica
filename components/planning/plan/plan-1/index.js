...
//         <div
//           // key={imageIndex - 1}
//           className={styles.complex__grid_prev_item}
//         >
...
//         <div className={styles.complex__grid_next_item}>
//           {images_1[imageIndex]}
//         </div>
//       </AnimatePresence> */}
//        <AnimatePresence initial={false} custom={direction}>
...
//           className={styles.complex__grid_prev_item}
//         >
//           <Image src={images_1[imageIndex]} height={515} width={478} alt=""/>
//         </div>
...
//         >
//           <Image key={page} src={images_1[imageIndex]} height={515} width={478} alt=""/>
//         </motion.div>
