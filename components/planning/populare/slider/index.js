...
import Page_1_m from '../carousel/populare-1-mob'
import Page_2_m from '../carousel/populare-1-mob'
import Page_3_m from '../carousel/populare-1-mob'
...
export const Slider = () => {
  ...
  return (
      ...
      >
        ...
        >
          <g clipPath="url(#clip0_101_2128)">
            <path
              d="M7.2105 22.4505C6.8999 22.0512 6.89985 21.4036 7.21055 21.0042L14.6026 11.5003L7.2105 1.99596C6.8999 1.59662 6.89985 0.949027 7.21055 0.549618C7.52121 0.150209 8.02483 0.150209 8.33549 0.549618L16.29 10.7772C16.4392 10.969 16.523 11.2291 16.523 11.5003C16.523 11.7715 16.4392 12.0317 16.29 12.2234L8.33543 22.4504C8.02483 22.8499 7.52115 22.8499 7.2105 22.4505Z"
              fill={page > images.length?"#2BB018":"#fff"}
            />
          </g>
          <g clipPath="url(#clip1_101_2128)">
            <path
    ...
    <div className={styles.slider__body_mob}>
      <AnimatePresence initial={false} custom={direction}>
        <motion.div
          key={imageIndex}
          className={styles.img}
        ...
        >
          <div key={imageIndex}>
          {images__mob[imageIndex]}
          </div>
        </motion.div>
      </AnimatePresence>
      <div className={styles.slider__counter_mob}>
        <span className={styles.inner__counter}>{page + 1}</span>/<span className={styles.length__counter}>{images.length + 2}</span>
      </div>
      <button
        type="button"
        disabled={page <= 0}
