            ...
            <div className={styles.inner}>
              ...
              <div className={styles.navigate__side}>
                <div className={styles.buttons__up}>
                  <button className={styles.button__about}>Despre CASĂ</button>
                  <button className={styles.button__planning}>
                    PLANIMETRII
                  </button>
                </div>
                <button className={styles.button__send}>SOLICITĂ OFERTA</button>
              </div>
            </div>
