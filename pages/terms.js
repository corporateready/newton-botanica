    ...
    <section className={styles.terms__section}>
      <div className={styles.container}>
        ...
        <p className={styles.terms__text}>
          ...
          conditions. Do not continue to use NEWTON HOUSE Grădina Botanică if
        ...
        <p className={styles.terms__text}>
          Unless otherwise stated, BINA-AGENCY S.R.L and/or its licensors own
          the intellectual property rights for all material on NEWTON HOUSE
          Grădina Botanică. All intellectual property rights are reserved. You
          may access this from NEWTON HOUSE Grădina Botanică for your own
        ...
        <ul>
          Republish material from NEWTON HOUSE Grădina Botanică Sell, rent or
          sub-license material from NEWTON HOUSE Grădina Botanică Reproduce,
          duplicate or copy material from NEWTON HOUSE Grădina Botanică
          Redistribute content from NEWTON HOUSE Grădina Botanică
        </ul>
        <p className={styles.terms__text}>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          BINA-AGENCY S.R.L does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of BINA-AGENCY S.R.L,its agents and/or affiliates.
          ...
          BINA-AGENCY S.R.L shall not be liable for the Comments or for any
        ...
        <p className={styles.terms__text}>
          BINA-AGENCY S.R.L reserves the right to monitor all Comments and to
          remove any Comments which can be considered inappropriate, offensive
          or causes breach of these Terms and Conditions.
        </p>

        <p className={styles.terms__text}>You warrant and represent that:</p>
        ...
        <p>
          ...
          the hyperlink compensates the absence of BINA-AGENCY S.R.L; and (d)
        ...
        <p className={styles.terms__text}>
          ...
          sending an e-mail to BINA-AGENCY S.R.L. Please include your name, your
