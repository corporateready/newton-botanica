      ...
      <div className={styles.container}>
        <div className={styles.terms__inner}>
          ...
          <p className={styles.terms__text}>
            ...
            botanica.newton.md, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information
            that is collected and recorded by NEWTON HOUSE Grădina Botanică and
            how we use it.
          </p>
          ...
          <p className={styles.terms__text}>
            ...
            advertising partners of NEWTON HOUSE Grădina Botanică.
          </p>
          ...
          <p className={styles.terms__text}>
            Note that NEWTON HOUSE Grădina Botanică has no access to or control
